...
class PDFField {
    ...
    static isWidgetSupported(field) {
        ...
        switch(field.fieldType) {
            ...
            case 'Sig': retVal = true; break; //Sign field    added this line  :: DINESH SAILOUR 25-03-2019
            default:
    ...
    #getFieldBaseData(field) {
        ...
        // }
        anData.TU = field.alternativeText; // DINESH SAILOUR

        if (field.alternativeID && field.alternativeID.length > 1) {
            anData.TM = field.alternativeID;
        }

        // after do many search i think the AM is greater then 0 if field is required
        // add field type       :: DINESH SAILOUR - 23-03-2019
        anData.fieldType = field.fieldType;
    ...
    processField() {
        ...
        switch(this.field.fieldType) {
            ...
            case 'Sig': _addAlpha.call(this, this.field); break; // added this line for sign field  :: DINESH SAILOUR - 25-03-2019
