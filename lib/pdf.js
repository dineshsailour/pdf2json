...
class PDFJSClass extends EventEmitter {
    ...
    constructor(needRawText) {
        ...
        this.TotalFields = 0; // Added by JEED DUMS
        // this.pageWidth = 0;
	...
	loadPages() {
		...
		return pagesPromise.then(
			...
			promisedPages => this.parsePage(promisedPages, 0, 24), // DINESH SAILOUR
    ...
    parsePage(promisedPages, id, scale) {
        ...
        function continueOnNextPage() {
            ...
            if (id === (this.pdfDocument.numPages - 1) ) {
                // added this.TotalFields as need total fields count  and remove Width: this.pageWidth as its added pag wise
                // DINESH SAILOUR    - 29-03-2019
                this.raiseReadyEvent({TotalFields:this.TotalFields,Pages:this.pages});
        ...
        pageParser.parsePage(
	        data => {
                // added width parameters to below page object       :: DINESH SAILOUR - 23-03-2019
	...
	//                 Texts: pageParser.Texts,
	            ...
	            // console.info(pageParser.Fields.length);
	            // console.info(pageParser.Boxsets.length);

                // Added below line by          :: DINESH SAILOUR   - 29-03-2019
                this.TotalFields += page.Fields.length + pageParser.Boxsets.length;

                // console.info(this.TotalFields);
	...
	getAllFieldsTypes() {
        // change TotalFields:this.TotalFields,Pages:this.pages         :: DINESH SAILOUR - 29-03-2019
		return PDFField.getAllFieldsTypes({TotalFields:this.TotalFields,Pages:this.pages || []});
	}
	...
	getMergedTextBlocksIfNeeded() {
        ...
        // change TotalFields:this.TotalFields,Pages:this.pages     :: DINESH SAILOUR - 29-03-2019
		return {TotalFields:this.TotalFields,Pages:this.pages};
	}
